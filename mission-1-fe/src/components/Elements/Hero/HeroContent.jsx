...
const HeroContent = ({ title, synopsis }) => (
            <div className="absolute inset-0 z-0 block items-end justify-start max-w-md sm:max-w-[700px] lg:max-w-[1400px] mb-[3em] mt-[4em] mr-[10em] ml-[1em] lg:mb-[20em] lg:mt-[17em] lg:mr-[4em] lg:ml-[4em] sm:mb-[10em] sm:mt-[10em] sm:mr-[2em] sm:ml-[3em]">
