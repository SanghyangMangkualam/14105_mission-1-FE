...
const Navbar = () => {
    return (
        <nav className="fixed top-0 left-0 right-0 flex justify-between items-center w-full bg-transparent">
            <div className="flex items-center justify-evenly w-lg">
            ...
            <div className="profile flex items-center justify-end w-xs">
